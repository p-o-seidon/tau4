...
"""\package tau4.robotix.mobile.kinematix   Kinematik für mobile Roboter.

Dieses Modul enthält die Beschreibung geometrischer Beziehungen für mobile Roboter.
"""
...
class ChassisDatasheet4Tests(ChassisDatasheet):
